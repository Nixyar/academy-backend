...
const messages = {
  ...
  COURSE_QUOTA_NOT_CONFIGURED: 'Лимиты для курса настроены, но квоты ещё не подключены. Попробуйте позже.',
  COURSE_QUOTA_EXCEEDED: 'Лимит запросов для этого курса исчерпан.',
